...
class PoisonedDataset(Dataset):
    ...
    def reshape(self, data, dataname="mnist"):
        if dataname == "mnist":
        ...
        elif dataname.lower() in ["flowers102", "oxfordpets", "stanfordcars", "food101", "dtd", "sun397", "eurosat"]:
            ...
            for img in data:
                if isinstance(img, Image.Image):
                    ...
                    new_data.append(torch.Tensor(img))
            new_data = torch.stack(new_data)  # Stack if possible
