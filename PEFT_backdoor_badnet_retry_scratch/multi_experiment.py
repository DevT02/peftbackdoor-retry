...
epochs_list = [30, 50]      # Number of epochs (at least 50, as requested)
...
# Main loop
##########################
for r, alpha, p_ratio, epochs, lr_val, batch_size in itertools.product(
    ranks, alphas, poison_ratios, epochs_list, lr_list, batch_sizes
):
